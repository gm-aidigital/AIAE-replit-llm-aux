...
7. Add entity/repo (domain), record/mapper/service (service), Liquibase in `db/changelog/changes/`; use MapStruct for create/update mapping and `CurrentTime` for timestamps.
